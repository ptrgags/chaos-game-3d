...
impl Xform {
    ...
    pub fn transform(&self, point: &Versor) -> Versor {
...
fn get_versor(versor_desc: &JsonValue) -> Versor {
    ...
    match xform_type {
        ...
        "rotate" => {
            if let [nx, ny, nz, theta_deg] = &parameters[..] {
                ...
                Versor::rotation(*nx, *ny, *nz, angle)
            } else {
